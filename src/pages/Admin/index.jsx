...
import { Utensils, Dumbbell, Pill, BellRing, Target, LogOut } from 'lucide-react'
      ...
      <div className="mt-4 space-y-2">
        {SECTIONS.map(({ to, label, icon: Icon }) => (
          <Link
            key={to}
            to={to}
            className="flex items-center gap-3 rounded-xl bg-surface px-4 py-4 text-white transition hover:bg-surface2"
          >
